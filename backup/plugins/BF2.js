...
module.exports = function (parent, chanName) {
	...
	cmdHandler.viewsheet = function (args, data) {
		if (!fChatLibInstance.isUserChatOP(data.character, channel)) {
			fChatLibInstance.sendPrivMessage("You are not an admin.", channel); return 0;
		}
	...
	cmdHandler.loadFight = function (args, data) {
		...
		if (datas[(numero-1)].actores[0] != persona && datas[(numero-1)].actores[1] != persona && persona != "esta persona es un administrador con poderes sobre humanos") {
			fChatLibInstance.sendMessage("You're not a participant of that match or an admin.", channel); return 0;
		}
