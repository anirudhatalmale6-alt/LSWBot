...
function searchDestinies(part) {
	var destinies = {
		...
		tits: ["tits","breasts","boobs","nipples","chest","tit","breast","boob","nipple","torso"],
		sex: ["sex","pussy","cock","slit","shaft","cunny","cunt","clit","dick","vagina","penis","balls"],
...
function searchOrigins(part) {
	var origins = {
		fingers: ["fingers","hands","paws","finger","hand","paw","thumb"],
		lips: ["lips","mouth","throat","tongue","maw","muzzle","face"],
		tits: ["tits","breasts","boobs","nipples","chest","tit","breast","boob","nipple","torso"],
		sex: ["sex","pussy","cock","slit","shaft","cunny","cunt","clit","dick","vagina","penis","balls"],
		ass: ["ass","butt","rump","rear","butthole","buttcheeks","tail"],
		feet: ["feet","legs","toes","thighs","knee","thigh","foot","leg"]
	};
