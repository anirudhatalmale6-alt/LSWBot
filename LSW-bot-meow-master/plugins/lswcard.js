...
module.exports = function (parent, chanName) {
	...
	cmdHandler.leave = function (args, data) {
		if (started) {
	...
	cmdHandler.remove = function (args, data) {
		if (started) {
	...
	cmdHandler.players = function (args, data) {
	...
	cmdHandler.start = function (args, data) {
		if (!started) {
	...
	cmdHandler.stop = function (args, data) {
		characters = [];
		if (started) {
			started = false;
			currentDeck = [];
